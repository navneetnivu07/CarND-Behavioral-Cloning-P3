...
# Download the Zip file provided by udacity contains Images and Csv
...
def uncompress_features_labels(dir,name):
    if(os.path.isdir(name)):
        ...
        with ZipFile(dir) as zipf:
            zipf.extractall('dd')
uncompress_features_labels('data.zip','dd')

print('All files downloaded and extracted')

samples = [] #simple array to append all the entries present in the .csv file

with open('./dd/data/driving_log.csv') as csvfile: #currently after extracting the file is present in this path
